...
function PriceTooltip({
  ...
  return (
    <div className="bg-gray-950 border border-gray-700 rounded-lg px-3 py-2 text-xs space-y-1 shadow-xl">
...
export function PriceChart({ symbol }: PriceChartProps) {
  ...
  return (
    <div className="space-y-1.5">
      {/* Price + SMAs */}
      <div className="rounded-xl border border-gray-800 bg-gray-900/50 p-3 pb-2">
